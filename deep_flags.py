...
flags.DEFINE_integer('hidden3_units', 128,
                     'Number of units in hidden layer 3.')
flags.DEFINE_integer('num_data', 8000, 'Number of classes')
flags.DEFINE_integer('num_train', 593*2, 'Number of classes')
flags.DEFINE_integer('num_test', 2230*2, 'Number of classes')
